//======================================================================================================================
// Class for managing the LCD configuration.
//
// Dependencies:
...
if (!window['$'])
   {
   var noJQuery = "The jQuery library is required by edu.cmu.ri.terk.LCDConfigManager.js";
   alert(noJQuery);
...
if (!JSON)
   {
   var msg3 = "The json2.js library is required by edu.cmu.ri.terk.LCDConfigManager.js";
   alert(msg3);
...
(function()
   ...
   edu.cmu.ri.terk.LCDConfigManager = function(host)
      {
      ...
      var loadLCDConfig = function(onSuccessCallbackFunction)
         {
         // load the config
         jQuery.ajax(
         {
            url: host + '/cgi-bin/getLCDConfigAsJSON.pl',
      ...
      this.saveLCDConfig = function()
         ...
         if (this.isModified())
            ...
            jQuery.ajax(
            {
               url: host + '/cgi-bin/saveLCDConfig.pl',
               type: 'POST',
