                  ...
                  unsigned long block_mask, int buffer_size)
{
    ...
    BA = (flash_t *)(block_mask & (unsigned int)addr);
	...
	// convert 'wc' in bytes to 'wc' in 'flash_t' 
        ...
        *FLASH_P2V(BA) = FLASH_Write_Buffer;
        timeout = 5000000;
        ...
        *FLASH_P2V(BA) = FLASHWORD(wc-1);  // Count is 0..N-1
        for (i = 0;  i < wc;  i++) {
