...
do_exec(int argc, char *argv[])
{
    ...
    //
    // The EP93xx ethernet uses DMA to write packets into system memory.  We
    // must therefore shut it down before starting Linux to avoid it
