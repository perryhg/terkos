...
int main(int argc, char **argv)
{
  ...
  *gpio.Uint(0x10) |= 0x00000002; // set PA ddr
  *gpio.Uint(0x10) &= ~0x00000084; // set PA ddr
  *gpio.Uint(0x00) &= ~0x00000002; // set PROG to high (run)
  ...
  *gpio.Uint(0x00) |= 0x00000002; // set PROG to low (reset)
  usleep(1);
  *gpio.Uint(0x00) &= ~0x00000002; // set PROG to high (run)
